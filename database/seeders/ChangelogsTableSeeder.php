...
<p>Thanks!.</p>',
            ...
            [
                'id' => 5,
                'title' => 'sos-vault 2.1.2 Released',
                'description' => 'A small reliability release: the self-hosted appliance now carries the sosreport filename-validation fix already shipped to SaaS in 2.1.1.',
                'body' => '<p><strong>Bug fix</strong></p><ul><li>sosreport uploads whose filename can\'t be reliably parsed are now rejected with a clear error instead of being silently accepted — this fix shipped to sos-vault SaaS in 2.1.1 and is now fully in sync on the self-hosted appliance. No other functional changes.</li></ul>',
                'created_at' => '2026-08-30 12:00:00',
                'updated_at' => '2026-08-30 12:00:00',
            ],
            [
                'id' => 6,
                'title' => 'sos-vault 2.2.0 Released',
                'description' => "New: Alerts and a Compliance & Exposure Engine.\nPlus nginx and dependency security updates.",
                'body' => '<p><strong>New features</strong></p><ul><li><strong>Alerts</strong> — vault-wide alert rules (file-pattern match, metric threshold, or reference-case diff) evaluated automatically on every new sosreport upload, with in-app, email, and event-log/SIEM delivery on every install (Slack delivery requires a license)</li><li><strong>Compliance & Exposure Engine</strong> — every uploaded sosreport is automatically assessed against CIS, STIG, and Docker Bench benchmarks, plus a network/software/identity/systemd exposure check, no configuration required. Free on every plan and appliance install</li></ul><p><strong>Security</strong></p><ul><li>Hardened nginx TLS and security headers: HSTS, a staged Content-Security-Policy, and a www → bare-domain redirect</li><li>Updated dependencies flagged by our Composer security audit</li></ul>',
