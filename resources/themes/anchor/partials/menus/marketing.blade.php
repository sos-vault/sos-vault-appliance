...
@guest
    <div class="hidden relative z-30 shrink-0 justify-center items-center space-x-3 h-full text-sm md:flex">
...
@else
    <x-button href="{{ route('login') }}" tag="a" class="text-sm" class="relative z-20 shrink-0">View Dashboard</x-button>
@endguest
