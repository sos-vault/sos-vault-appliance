...
<body>
	...
	<div class="wrapper">
		...
		<div role="main" class="main">
            ...
            <div>
                <h1 class="text-2xl green"><?php echo $messages[0]; ?></h1>

                <h2 class="text-3xl mt-2 mb-4 font-semibold">Server Error: 405 (Method Not Allowed)</h2>
            </div>
			...
			<p class="mt-4 text-lg">
				The page you requested does not support the request method used. We're really sorry
				about that.
			</p>
