...
<head>
	...
	<title>Error 504 - Gateway Time-out</title>
	...
	<div class="wrapper">
		...
		<div role="main" class="main">
            ...
            <div>
                ...
                <h2 class="text-3xl mt-2 mb-4 font-semibold">Server Error: 504 (Gateway Time-out)</h2>
            </div>
			...
			<p class="mt-4 text-lg">
                We are currently working on an scheduled maintenance window. sos-vault is temporarily
                out of service. We're really sorry about this, please retry accessing the site again
                in a few minutes.
			</p>
