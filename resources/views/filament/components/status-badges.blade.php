...
>
    ...
    {{-- ALERT badge — color tracks severity: INFO gray, WARNING yellow, ERROR orange, CRITICAL/FATAL red --}}
    <template x-if="$wire.hasTriggeredAlert">
        <span
            class="fi-badge flex items-center justify-center gap-x-1 rounded-md text-xs font-medium ring-1 ring-inset px-2 min-h-6 py-0.5 whitespace-nowrap"
            :class="{
                gray: 'bg-zinc-50 text-zinc-700 ring-zinc-600/10 dark:bg-zinc-400/10 dark:text-zinc-400 dark:ring-zinc-400/20',
            ...
            }[$wire.alertBadgeColor]"
            x-text="'ALERT: ' + $wire.alertSeverity"
        ></span>
    </template>
