            ...
            <div class="w-full h-full">
                <div x-data="{ 
                    ...
                    <header class="flex space-x-3 w-full">
                        <div class="flex overflow-hidden shrink-0 rounded divide-x divide-gray-700">
                        ...
                        <button class="shrink-0 p-2 text-gray-700 bg-white rounded ring-1 ring-gray-200 hover:bg-gray-100">
                        ...
                        <div class="flex overflow-hidden shrink-0 rounded divide-x divide-gray-200 ring-1 ring-gray-200">
                    ...
                    <nav class="flex justify-between items-center py-2 w-full text-xs">
                        <ol role="list" class="flex items-center space-x-1">
                            ...
                            @foreach($breadcrumbs as $breadcrumb)
                                <li><svg class="shrink-0 w-5 h-5 text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"><path d="M5.555 17.776l8-16 .894.448-8 16-.894-.448z"></path></svg></li>
                                <li>
                                    <button 
                    ...
                    <div class="flex justify-start items-stretch space-x-10 w-full h-full">
                        ...
                        <active-file x-show="activeFileDrawer" class="relative shrink-0 w-68 h-full  bg-gray-50 rounded-md p-3">
