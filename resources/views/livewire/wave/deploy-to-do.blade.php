    ...
    <div class="flex flex-col justify-center items-center w-full h-screen bg-zinc-50">
        ...
        @if(!$app_id)
            <div class="overflow-hidden mx-auto w-full max-w-lg bg-white rounded-lg border shadow-xl border-zinc-100">
                <div class="flex relative items-center pl-5 w-full h-20 text-white bg-center bg-cover bg-linear-to-br from-blue-500 to-blue-600" style="background-image:url('{{ Storage::url('/settings/April2021/deploy-banner.png') }}')">
