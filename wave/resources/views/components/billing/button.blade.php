...
@php
    $colorClasses = match ($color) {
        ...
        'primary' => 'bg-primary-600 text-white hover:bg-primary-600/90 focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-900 focus:bg-primary-700/90 focus:ring-primary-700',
        default => 'bg-primary-600 text-white hover:bg-primary-600/90 focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-900 focus:bg-primary-700/90 focus:ring-primary-700',
    };
@endphp
