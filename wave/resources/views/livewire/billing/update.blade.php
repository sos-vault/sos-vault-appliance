<div class="relative w-full h-auto">
    @if(config('wave.billing_provider') == 'paddle')
        ...
        <div class="flex items-start space-x-2">
            ...
            @if($update_url)
                <x-button color="primary" href="{{ $update_url }}" tag="a" class="shrink-0">Update Payment Details</x-button>
            @endif
            ...
            @else
                <x-filament::modal width="lg" id="cancel-modal">
                    ...
                    <div x-data class="flex relative flex-col justify-center items-center">
                        <div class="flex shrink-0 justify-center items-center mx-auto w-12 h-12 bg-red-100 rounded-full sm:mx-0 sm:h-10 sm:w-10">
