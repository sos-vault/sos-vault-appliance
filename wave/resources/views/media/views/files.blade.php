...
<div 
        ...
        >
            <div 
                :class="{ 
                    ...
                    'w-10 h-10 shrink-0 p-2' : view == 'list'
                }"
                ...
                <template x-if="file.type == 'folder'">
                    <svg 
                        :class="{ 
                            ...
                            'w-full h-full shrink-0 fill-current text-[#fbd775]' : view == 'list'
    ...
    <template x-teleport="body">
        <div wire:ignore x-show="contextMenuOpen" x-on:click.away="contextMenuOpen=false" x-ref="contextmenu" class="ctx min-w-32 text-neutral-800 rounded-md border border-neutral-200/70 bg-white text-sm fixed p-1 shadow-md w-64 z-99" x-cloak>
            <div x-show="!contextMenuFileClicked" class="relative w-full">
                ...
                <div class="relative group">
                    ...
                    <div data-submenu class="absolute top-0 right-0 invisible mr-1 opacity-0 duration-200 ease-out translate-x-full group-hover:mr-0 group-hover:visible group-hover:opacity-100">
                        <div class="min-w-32 overflow-hidden rounded-md border bg-white p-1 shadow-md animate-in slide-in-from-left-1 w-48">
