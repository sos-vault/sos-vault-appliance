<x-filament-widgets::widget class="fi-filament-info-widget">
    <x-filament::section>
        <div class="flex relative z-0 gap-x-3 items-center">
            <div class="flex absolute z-30 flex-col justify-center items-center w-full h-full">
              <p class="mx-auto mb-5 max-w-md text-sm text-center text-zinc-400">Click the button to learn how to setup analytics for your application.</p>
            ...
            <div class="absolute inset-0 z-20 w-full h-full bg-linear-to-t from-white"></div>
